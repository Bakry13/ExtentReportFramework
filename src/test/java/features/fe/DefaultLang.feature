@THOR-33 @FERegression
Feature:Default Language
  As a customer, I want to have the possibility to change the language of the data displayed in the Easy Ticket portal, in case I wasn't comfortable with Portal default Language display
